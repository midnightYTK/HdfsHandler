...
public class UserResponse implements org.apache.thrift.TBase<UserResponse, UserResponse._Fields>, java.io.Serializable, Cloneable, Comparable<UserResponse> {
  ...
  public UserResponse setCode(@org.apache.thrift.annotation.Nullable java.lang.String code) {
    this.code = code;
    return this;
  }
  ...
  public UserResponse setParams(@org.apache.thrift.annotation.Nullable java.util.Map<java.lang.String,java.lang.String> params) {
    this.params = params;
    return this;
  }
